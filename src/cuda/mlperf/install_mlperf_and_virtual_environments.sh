...
if [ -f "$BASE_MLPERF_INFERENCE_DIR/virtual_environment_pytorch/bin/activate" ]; then
    ...
    wget -nc https://gist.githubusercontent.com/vsajip/4673395/raw/0504ce930e6dc6b02e4955a07d91ad462e0ba80b/pyvenvex.py
    #################################################
...
if [ -f "$BERT_DEPEND" ]; then
    ...
    cd ../language/bert
    pip install onnx==1.8.1 transformers tokenization onnxruntime==1.2.0 numpy==1.18.0
